...
$content['LN_DBUPGRADE_VERSION_NOT_BUMPED'] = "Die gespeicherte Datenbank-Version wurde nicht erhöht, weil mindestens ein SQL-Statement fehlgeschlagen ist. Beheben Sie die oben genannten Fehler (oder stellen Sie ein Backup wieder her) und führen Sie das Upgrade erneut aus. Bis dahin bietet UltraStats dieses Upgrade weiterhin an.";
