...
$content['LN_CUSTOM_Medals'] = "Custom Medals";
...
$content['LN_CFG_DBSTORAGEENGINE'] = "Table storage engine";
$content['LN_CFG_DBSTORAGEENGINE_HELP'] = "InnoDB (recommended) supports transactions and better crash recovery. MyISAM is a legacy option for older servers or a smaller on-disk footprint.";
