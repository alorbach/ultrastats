...
$content['LN_GEN_WEB_SHOWANTIMEDALS'] = "Show Anti Medals block on main page (Pro/Custom still follow \"Show Medals\" above)";
...
$content['LN_ADMINMEDALSGROUP_PRO'] = "Pro / skill medals";
$content['LN_ADMINMEDALSGROUP_ANTI'] = "Anti medals";
$content['LN_ADMINMEDALSGROUP_CUSTOM'] = "Custom medals";
$content['LN_ADMINMEDALSGROUP_ENABLEALL'] = "Enable or disable all medals in this group at once.";
$content['LN_ADMINMEDAL_AUTOSAVE_SAVING'] = "Saving configuration…";
$content['LN_ADMINMEDAL_AUTOSAVE_RECALC'] = "Recalculating medals…";
$content['LN_ADMINMEDAL_AUTOSAVE_DONE'] = "Medals updated.";
$content['LN_ADMINMEDAL_AUTOSAVE_ERR'] = "Could not save or recalculate. Use Send to save.";
...
$content['LN_PARSER_CANCEL'] = "Cancel parse";
$content['LN_PARSER_CANCELLING'] = "Cancelling at next safe point…";
$content['LN_PARSER_CANCELLED_STATUS'] = "Parse was cancelled.";
$content['LN_PARSER_DONE'] = "DONE";
